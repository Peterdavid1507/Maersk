<%@ Page Title="Edit Shipping Information" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditShipping.aspx.cs" Inherits="Maersk.EditShipping" Async="true" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h6>
        (<asp:Label runat="server" Font-Bold="true" ForeColor="#ae0000">Click "View Shippings" and click "Edit" on the desired shipping information</asp:Label>, if field is not populated with respective information)
    </h6>
    <hr />
    ...
    <div class="form-horizontal" id ="CUS">
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                ...
                <asp:RequiredFieldValidator runat="server" ControlToValidate="Departure" ID="valDeparture"
